          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="text-5xl leading-tight font-bold md:text-6xl">
                ...
                <br />
                <span className="text-gray-900">seus agendamentos médicos</span>
              </h1>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              ...
              <button className="rounded-full border-2 border-gray-300 px-8 py-4 text-lg font-semibold text-gray-700 transition-all duration-300 hover:cursor-pointer hover:border-blue-600 hover:text-blue-600">
                Ver Demonstração
              </button>
            </div>
