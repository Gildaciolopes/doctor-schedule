      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div
              key={index}
              className="group transform rounded-2xl bg-gray-50 p-8 transition-all duration-300 hover:-translate-y-2 hover:cursor-pointer hover:bg-white hover:shadow-lg"
            >
              <div
