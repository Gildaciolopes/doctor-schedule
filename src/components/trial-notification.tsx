...
export function TrialNotification({
  ...
  return (
    <Alert
      className={`mb-4 ${isUrgent ? "border-orange-200 bg-orange-50 dark:border-orange-800 dark:bg-orange-900/20" : "border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20"}`}
    >
        ...
        <div className="flex items-start space-x-2">
          ...
          >
            {isUrgent ? (
              ...
              <>
                <strong>Período de teste ativo</strong> - Restam {daysRemaining}{" "}
                dias para explorar todas as funcionalidades gratuitamente.
              </>
            )}
          </AlertDescription>
        </div>
